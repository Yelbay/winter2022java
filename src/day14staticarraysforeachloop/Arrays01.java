...
public class Arrays01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========");
        //sort the arrays elements according to their lengths===>Ali Veli Maria Michael
        String crr[]={"Ali","Veli","Michael","Maria"};

        Arrays.sort(crr, Comparator.comparingInt(String::length).reversed());
        ...
        String vrr[]={"Veli","Ayse","Cennet","Mujdat","Can"};
        //Natural
       Arrays.sort(vrr,Comparator.comparingInt(String::length).reversed().thenComparing(Comparator.naturalOrder()));
    }
}