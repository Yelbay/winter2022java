...
public class ForLoop01 {
    public static void main(String[] args) {
        ...
        //5.Example;Type code to find sum of the digits of an integer
        int n = 234;
        int sumOfDigits = 0;
        ...
        int numm = 12321;
        int summ = 0;
        String stringOfNumm = String.valueOf(numm);
        System.out.println(stringOfNumm);
        for (int i = 0; i < stringOfNumm.length(); i++) {
            summ += Integer.valueOf("" + stringOfNumm.charAt(i));
        }
        System.out.println("Sum of all digits of integer is :" + summ);
